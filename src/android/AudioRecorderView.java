...
public class AudioRecorderView extends RelativeLayout {
    ...
    private static int OUTPUT_FORMAT = MediaRecorder.OutputFormat.AMR_WB;
    private static String EXTENSION_FILE = "wav";
...
// Generate file name and get the path to save the files
                ...
                filePath = android.os.Environment.getExternalStorageDirectory().getPath() + "/" + fileName;
